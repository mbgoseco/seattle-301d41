...
Student.prototype.greeting = (name) => `Hi, my name is ${name}`;

// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!
console.log(joe.greeting(joe.name));
...
// "This" is the joe instance and return the key/values of joe.
// 
// 2. What is "this" when joe.scopeArrow() is invoked?
// "This" becomes the scope of the window and returns key/values of the global window object.
//
// 3. Explain why "this" is different when an arrow function is used.
// Because when an arrow function is used, the scope of the function goes up to next nearest scope.
